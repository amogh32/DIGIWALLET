...
<body>
	<center><h1>Add money</h1></center>
	<br>
	<br>
	<br>
	<center>
		<form action="action_add_money.php" method="post">
		<table cellpadding="12" class="formtable">
			...
			<tr>
				<td> </td>
				<td><center> <input type="submit" onclick="return check()" value="Add" class="btn"> </center></td>
			</tr>
		</table>
		</form>
	</center>
