...
<body>
	<div class="topnav" style="margin-left:350px;padding:12px">
		<a href="newdebt.php" class="active" class="apart">New debt</a>
	...
	<center>
		...
		<form action="action_newdebt.php" method="post">
		<table cellpadding="12" class="formtable">
			...
			<tr>
				<td></td>
				<td><center> <input type="submit" onclick="return check()" value="MAKE DEPT REQUEST" class="btn"> </center></td>
			</tr>
		</table>
		</form>
	</center>
